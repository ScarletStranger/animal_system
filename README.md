...
13. Создать [класс с Инкапсуляцией методов и наследованием по диаграмме](https://github.com/ScarletStranger/animal_system/tree/main/src/Model).
14. Написать [программу, имитирующую работу реестра домашних животных](https://github.com/ScarletStranger/animal_system/tree/main/src).
...
15. Создайте [класс Счетчик](https://github.com/ScarletStranger/animal_system/blob/main/src/Controller/Counter.java),
...
![Program](https://github.com/ScarletStranger/animal_system/blob/main/screencshots/333.png)
